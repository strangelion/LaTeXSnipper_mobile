...
"settings.skin": "皮肤",
  ...
  "share.webdavUrl": "WebDAV 服务器地址（自动存储到 latexsnipper/ 子目录）",
  "share.webdavUser": "用户名",
  "share.webdavPassword": "WebDAV 密码",
  "share.encryptPassword": "加密密码（至少 8 位）",
  "share.download": "下载并合并",
  "share.upload": "加密上传",
  "share.webdavHint": "WebDAV 内容会先用本机输入的加密密码加密，再上传到服务器。请记住该密码，丢失后无法解密。凭据将加密保存到本地，无法查看，只能覆盖。",
  "share.imported": "已合并：新增 {{added}} 条，更新 {{updated}} 条",
  "share.pushed": "已推送到桌面端：新增 {{added}} 条，更新 {{updated}} 条",
  "share.uploaded": "已加密上传到 WebDAV",
  "hw.sendDesktop": "发送到桌面",
  "hw.sending": "发送中…",
  "hw.needLanSettings": "请先在「共享」中填写局域网地址和 PIN",
  "hw.desktopResult": "桌面端识别完成",
  "hw.noResult": "桌面端未识别到内容",
  "hw.sendFailed": "发送失败",
  "share.autoSyncTitle": "定时同步",
  "share.autoSyncEnable": "启用定时同步",
  "share.autoSyncHint": "启用后会定时从 WebDAV 拉取并合并最新历史。需先填写上方 WebDAV 凭据。",
  "share.autoSyncSkip": "跳过同步：未填写 WebDAV 凭据",
  "share.autoSyncRunning": "正在同步…",
  "share.autoSyncDone": "已合并：新增 {{added}} 条，更新 {{updated}} 条",
  "share.autoSyncError": "同步失败",
}
